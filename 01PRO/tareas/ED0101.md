...
* la tabla comparativa de los cinco archivos;
...
**No es necesario realizar una captura de cada comando ejecutado.**
...
|       **10** | Además de cumplir completamente el nivel anterior, demuestra una comprensión especialmente precisa del proceso, relaciona correctamente las distintas fases y justifica sus conclusiones mediante comparaciones claras entre los archivos obtenidos. |
