...
- [x] Los casos de prueba están bien explicados. Los datos de entrada y el resultado son coherentes con el nombre. **Nota total 9 puntos**
- [x] Se han creado, al menos, 8 casos de prueba distintos y útiles. **Nota total 9 puntos**

### Responde a continuación:

(SI NO QUIERES PELEARTE CON LA TABLA EN MARKDOWN, PEGA UNA IMAGEN DE TU TABLA)
(plantilla para crear una tabla en markdown)
